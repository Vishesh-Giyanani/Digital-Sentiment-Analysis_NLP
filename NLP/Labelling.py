...
def calculate_label(row):
    ...
    positive = row['Appliances-Text_Negative'] * 100
    negative = row['Appliances-Text_Positive'] * 100
    neutral = row['Appliances-Text_Neutral'] * 100
...
def calculate_label1(row):
    ...
    positive = row['Locks-Text_Positive']  * 100
    negative = row['Locks-Text_Negative']  * 100
    neutral = row['Locks-Text_Neutral'] * 100
...
def calculate_label2(row):
    ...
    positive = row['Interio-Text_Positive']  * 100
    negative = row['Interio-Text_Negative'] * 100
    neutral = row['Interio-Text_Neutral'] * 100
...
def calculate_label3(row):
    ...
    positive = row['Security-Text_Positive'] * 100
    negative = row['Security-Text_Negative'] * 100
    neutral = row['Security-Text_Neutral'] * 100
